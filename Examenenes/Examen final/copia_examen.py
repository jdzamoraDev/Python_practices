...
empleado = input("Cual es el nombre del empleado #: ")
...
if (horas_trabajadas <= 40):
    ...
    print("Su salario es de",salario_base,"y sus horas extras son",salario_horas_extra,"Pero las horas extras que superan las 50 horas, no se pagan.")
